...
class ThirdFragment : Fragment() {
    ...
    private fun initData(){
        val name = resources.getStringArray(R.array.laut_name)
        val image = resources.obtainTypedArray(R.array.laut_image)
    ...
    fun initView(view: View){
        initData()
        val rv = view.findViewById<RecyclerView>(R.id.laut_list)
